...
public class CouponDAOImpl implements CouponsDAO {
	...
	public CouponDAOImpl(DataSource dataSource) {
	...
	public ArrayList<Coupon> getAllCoupons() throws SQLException, CategoryNotFoundException {
