...
import com.jhf.coupon.backend.exceptions.CantUpdateCouponException;
import com.jhf.coupon.backend.exceptions.CategoryNotFoundException;
import com.jhf.coupon.backend.exceptions.CouponAlreadyExistsForCompanyException;
...
public class CompanyFacade extends ClientFacade {
	...
	public ArrayList<Coupon> getCompanyCoupons(Company company) throws SQLException, CategoryNotFoundException, InterruptedException {
